                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="product_details_content">
                                                                ...
                                                                <div class="item_price">
                                                                    <span  id="pricdfe{{$product->id}}">{{$product->after_discount}}</span>
                                                                ...
                                                                <div class="item_attribute">
                                                                    ...
                                                                    <div class="quantity_input">
                                                                        <button type="button" class="input_number_decrement"  Data_pro_id="{{$product->id}}">
                                                                            <i class="fal fa-minus"></i>
                                                                        </button>
                                                                        <input class="input_number{{$product->id}}" type="text" value="1" name="quantity">
                                                                        <button type="button" class="input_number_increment" Data_pro_id="{{$product->id}}">
                                                                            <i class="fal fa-plus"></i>
                                                                        </button>
                                                                    </div>
                                                                    <div class="total_price">Total: <span id="Total_p{{$product->id}}">{{ $product->after_discount }}</span>
                                                                    </div>
                                                        </div>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="product_details_content">
                                                    ...
                                                    <div class="item_price">
                                                        <span id="prices{{$arivel->id}}">{{$arivel->after_discount}}</span>
                                                    ...
                                                    <div class="item_attribute">
                                                        ...
                                                        <div class="quantity_wrap">
                                                            <div class="quantity_input">
                                                                <button type="button" class="input_number_decrements"  Data_pros_id="{{$arivel->id}}">
                                                                    <i class="fal fa-minus"></i>
                                                                </button>
                                                                <input class="input_numbers{{$arivel->id}}" type="text" value="1" name="quantity">
                                                                <button type="button" class="input_number_increments" Data_pros_id="{{$arivel->id}}">
                                                                    <i class="fal fa-plus"></i>
                                                                </button>
                                                            </div>
                                                            <div class="total_price">Total: <span id="Total_ps{{$arivel->id}}">{{ $arivel->after_discount }}</span>
                                                            </div>
                                                        </div>
    ...
    $('.input_number_increment').click(function () {
        var products_id= $(this).attr('Data_pro_id')
        var quantityes= $('.input_number'+products_id).val()
         quantityes++
          $('.input_number'+products_id).val(quantityes);
           var prices = $('#pricdfe'+products_id).html();
         var totals = prices * quantityes;
         $('#Total_p'+products_id).html(totals);
    });
    $('.input_number_decrement').click(function () {
        var products_id= $(this).attr('Data_pro_id')
        var quantityes= $('.input_number'+products_id).val()
...
// arival inc
    $('.input_number_increments').click(function () {
        var product_id= $(this).attr('Data_pros_id')
        var quantity= $('.input_numbers'+product_id).val()
         quantity++

         $('.input_numbers'+product_id).val(quantity);
         var price = $('#prices'+product_id).html();
         var total = price * quantity;
         $('#Total_ps'+product_id).html(total);
    });
    $('.input_number_decrements').click(function () {
        var product_id= $(this).attr('Data_pros_id')
        var quantity= $('.input_numbers'+product_id).val()
        if (quantity > 1) {
                   quantity--
