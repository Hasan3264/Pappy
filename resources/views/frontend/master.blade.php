...
<body>
 ...
 <script type="text/javascript">
    ...
    s1.async=true;
    s1.src='https://embed.tawk.to/63221b6e54f06e12d894bb12/1gcujmasu';
    s1.charset='UTF-8';
               ...
               @endphp
                ...
                <li>
                    <div class="item_image">
                        <img src="{{asset('/uploads/product/preview')}}/{{$cart->relation_product->Product_preview}}" alt="image_not_found">
                    </div>
                    <div class="item_content">
                        <h4 class="item_title">{{ $cart->relation_product->product_name }}</h4>
                        <span class="item_price">{{ $cart->relation_product->after_discount }} * {{$cart->quantity}}</span>
                    </div>
                    <a  href="{{ route('cart.remove', $cart->id) }}"type="button" class="remove_btn"><i class="fal fa-trash-alt"></i></a>
                </li>
                     @php
                     $subtotal += $cart->relation_product->after_discount*$cart->quantity;
                     @endphp
                     @endforeach
            </ul>
                                ...
                                <ul class="header_icons_group ul_li_right">
                                    <li>
                                        <a href="{{route('wishlist.page')}}">
                                            ...
                                            <span class="wishlist_counter">{{ App\Models\wishlist::where('customer_id', Auth::guard('customerlogin')->id())->count() }}</span>
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <div class="allcategories_dropdown">
                                ...
                                <div class="allcategories_collapse {{ (Route::CurrentRouteName()== 'homepage'?'':'collapse') }}"
                                    ...
                                    <div class="card card-body">
                                        ...
                                        <div class="select_option mb-0 clearfix select select--multiple">
                                        <select id="category_id"  class="allcategories_list select" multiple>
                            ...
                            <nav class="main_menu navbar navbar-expand-lg">
                                <div class="main_menu_inner collapse navbar-collapse" id="main_menu_dropdown">
                                    ...
                                    <ul class="main_menu_list ul_li">
                                        ...
                                        <li><a class="nav-link" href="{{route('shop.in')}}">Shop</a></li>
                        ...
                        <div class="col col-md-3">
                            <ul class="header_icons_group ul_li_right">
                                <li>
                                    @auth('customerlogin')
                                    <div class="dropdown">
                                        <button style="background-color: #052840;"
                                            class="btn btn-secondary dropdown-toggle" type="button"
                                            id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                            {{ Auth::guard('customerlogin')->user()->name }}
                                        </button>
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li style="border-bottom: 1px solid blue;padding-bottom:5px; ">
                                                <a href="{{ route('customer.dashboard') }}" class="dropdown-item">
                                                    <svg role="img" xmlns="http://www.w3.org/2000/svg" width="30px"
                                                        height="30px" viewBox="0 0 24 24" stroke="#051d43"
                                    ...
                                    @else
                                    <a href="{{ route('customer.register') }}">Log In/Register</a>
                                    @endauth
                                </li>
